    ...
    return (
        <div>
            ...
            <section>
                <div className="hero lg:mt-[-500px] mt-[-300px] lg:p-14 p-5">
                    <div className="hero-content flex-col lg:flex-row-reverse ">
                        ...
                        <div>
                            <p className="lg:text-purple-200 text-purple-700 text-xl pb-4">Get To Know Us</p>
                            <h1 className="lg:text-5xl text-3xl lg:text-white text-purple-900 font-bold">Save Money With Specials <br />
                                Discount Offer</h1>
                            ...
                            <div className="flex gap-6">
                                <button className="btn bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-bold border-none">Contact Us</button>
            ...
            <section className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 pt-28 ml-12 ">
                {/* 1 */}
                <div className="card bg-neutral text-neutral-content w-96 hover:scale-105 transition-transform duration-300 mb-4">
                ...
                {/* 3 */}
                <div className="card bg-neutral text-neutral-content w-96 hover:scale-105 transition-transform duration-300">
                    <div className="card-body items-center text-center">
