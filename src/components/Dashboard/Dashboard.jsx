...
// import { FaAngellist, FaOpencart, FaSortAmountDown, FaTrashAlt } from "react-icons/fa";
...
//             </section>
//             {/* Product Cards */}
//             <section className="lg:w-[1000px] lg:mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-1 gap-6 p-4">
//                 {products.map((product) => (
//                     <div key={product.product_id} className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-gray-500">
//                         <div className="lg:flex">
//                             <div>
//                                 <img src={product.product_image} alt={product.product_title} className="lg:w-full h-48 object-contain pt-6" />
//                             </div>
//                             <div className="lg:pl-16">
//                                 <div className="lg:flex justify-between">
//                                     <h2 className="text-xl font-bold mt-4">{product.product_title}</h2>
//                                     <p className="text-red-700 lg:pl-96 pt-5 text-2xl"> <FaTrashAlt /></p>
//                                 </div>
//                                 <p className="text-gray-400 mt-2">{product.description}</p>
//                                 <p className="text-lg font-semibold mt-2">${product.price}</p>
//                                 {view === "wishlist" &&
//                                     <button className="btn mt-3 bg-purple-500 text-white hover:bg-purple-700 rounded-2xl">Add to Cart</button>}
//                             </div>
//                         </div>
//                     </div>
//                 ))}
